...
public class Profissional {
    ...
    // ---
    // Veja nas entidades existentes que o Filme tem um atributo pro seu diretor e o Profissional tem um atributo pros seus filmes dirigidos.
    // Em ambos os atributos do relacionamento é precisso que colocar as anotações OneToMany/ManyToOne/ManyToMany/OneToOne corretamente.
